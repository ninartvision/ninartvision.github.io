...
service_web_title: "ვებგვერდის შექმნა",
service_web_desc: "ინდივიდუალურად კოდირებული, responsive და სწრაფი ვებგვერდები.",
...
learn_more: "გაიგე მეტი",
      ...
      simple: {
        ...
        description: "სწრაფი, საპასუხო ერთი გვერდიანი ვებგვერდები მცირე ბიზნესებისთვის და პორტფოლიოებისთვის.",
        features: ["საპასუხო დიზაინი","SEO-მიმზიდველი მარკაპი","სწრაფი დატვირთვა","მსუბუქი განახლება"],
        cta: "დაგვიკავშირდი"
      },
      medium: {
        title: "საშუალო ვებგვერდი",
        hero: "მრავალფენოვანი ვებგვერდები პორტფოლიოსა და კონტაქტის ფორმით.",
        description: "მრავალ გვერდიანი ვებგვერდები კონტენტით, გალერეითა და კონტაქტის ფუნქციებით.",
      ...
      calc: {
        ...
        websiteCategories: { onepage: "ერთი გვერდი", info: "ინფორმაციული ვებგვერდი", business: "ბიზნეს ვებგვერდი", ecommerce: "ელ. კომერცია" },
        sizesTitle: "პროექტის ზომა",
        sizes: { small: "მცირე", medium: "საშუალო", large: "დიდი" },
        ...
        types: { website: "ვებგვერდის განვითარება", logo: "ლოგოს დიზაინი", social: "სოციალური მედია" },
